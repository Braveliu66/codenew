        ...
        if request.input_type in {"video", "camera"}:
            ...
            return PreviewPipelinePlan(
                ...
                pipeline_options={
                    ...
                    "lingbot_fps": request.options.get("lingbot_fps") or request.options.get("frame_sample_fps"),
                    "lingbot_first_k": request.options.get("lingbot_first_k"),
                    "lingbot_stride": request.options.get("lingbot_stride"),
        ...
        if request.input_type in {"video", "camera"}:
            ...
            lingbot_result = self._run_stage(
                ...
                spec={
                    ...
                    "lingbot_input_mode": plan.pipeline_options["lingbot_input_mode"],
                    "lingbot_fps": plan.pipeline_options.get("lingbot_fps"),
                    "lingbot_first_k": plan.pipeline_options.get("lingbot_first_k"),
                    "lingbot_stride": plan.pipeline_options.get("lingbot_stride"),
